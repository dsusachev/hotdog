        ...
        <div className="space-y-3">
          {results.map(r => (
            <div key={r.id} className="bg-white border border-gray-200 rounded-xl p-4 flex items-center gap-4">
              <div className="w-10 h-10 rounded-lg bg-teal-50 flex items-center justify-center text-xl flex-shrink-0">
                🥦
              </div>
              ...
              <span className="text-xs font-medium text-teal-600 whitespace-nowrap bg-teal-50 px-2 py-1 rounded-full flex-shrink-0">
                {r.calories} ккал
              </span>
            </div>
          ))}
